...
NDiplomacy = {
	...
	MAX_DIPLO_DISTANCE = 500,									-- Most diplomacy is disallowed if two rulers are too distant
	MAX_DIPLO_DISTANCE_SAME_RELIGION = 2000,						-- Bonus to max diplo distance for being of the same religion
	MAX_DIPLO_DISTANCE_SAME_RELIGION_GROUP = 1000, 				-- Bonus to max diplo distance for being of the same religion group
	MAX_DIPLO_DISTANCE_SAME_CULTURE = 2000, 						-- Bonus to max diplo distance for being of the same culture
	MAX_DIPLO_DISTANCE_SAME_CULTURE_GROUP = 500,				-- Bonus to max diplo distance for being of the same culture group
	MAX_DISTANCE_HOLY_WAR_JOIN = 1509,							-- How far away people are willing to join in defense against a holy war (capital to capital. Direct neighbors considered distance 0)
	MAX_DISTANCE_REL_HEAD_DEFENSE_JOIN = 4509,					-- How far away people are willing to join in defense of their rel head (capital to capital. Direct neighbors considered distance 0)
...
NMilitary = {
	...
	ARMY_MOVEMENT_SPEED = 4,						-- Base movement speed of land units
